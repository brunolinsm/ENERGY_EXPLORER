<?php
	...
	$pages = array(
		...
		'1'	=> array('id' => '5', 'alias' => 'Explorer', 'file' => '5.php','controllers' => array()),
		'2'	=> array('id' => '6', 'alias' => 'Contacts', 'file' => '6.php','controllers' => array())
	);
	$forms = array(
		'6'	=> array(
			'71ceb577' => Array( 'email' => 'brunolinsm@gmail.com', 'emailFrom' => '', 'subject' => 'Inquiry from the web page', 'sentMessage' => 'Form was sent.', 'object' => '', 'objectRenderer' => '', 'loggingHandler' => '', 'smtpEnable' => false, 'smtpHost' => null, 'smtpPort' => null, 'smtpEncryption' => null, 'smtpUsername' => null, 'smtpPassword' => null, 'recSiteKey' => null, 'recSecretKey' => null, 'fields' => array( array( 'fidx' => '0', 'name' => 'Name', 'type' => 'input', 'options' => '' ), array( 'fidx' => '1', 'name' => 'E-mail', 'type' => 'input', 'options' => '' ), array( 'fidx' => '2', 'name' => 'Message', 'type' => 'textarea', 'options' => '' ) ) )
		)
	);
	$langs = null;
	$def_lang = null;
	...
	$base_url = '/';
	$user_domain = 'energyexplorer.000webhostapp.com';
	$show_comments = false;
	include dirname(__FILE__).'/functions.inc.php';
	$home_page = '1';
	list($page_id, $lang, $urlArgs, $route) = parse_uri();
	$user_key = "beppfqT7FIYMJJbQmIusps1ggE2hMAW/ZLufW0uomyk=";
	$user_hash = "c18e8e5c2c4c0832";
